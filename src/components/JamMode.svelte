...
/* For larger collections, add some vertical overlap */
@media (min-width: 340px) {
  ...
  /* Add negative margin to create stacking effect when more than 3 items */
  .solved-artists-gallery .solved-artist-item:nth-child(n+4) {
    margin-top: -40px;
  }
  
  .solved-artists-gallery .solved-artist-item:nth-child(n+7) {
    margin-top: -40px;
  }
}

/* Add scrollbar styling for the gallery when many artists */
